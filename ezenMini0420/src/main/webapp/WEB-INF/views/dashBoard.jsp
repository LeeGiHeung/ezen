...
<div class="mb-3">
	...
	<a id="line" href="dash" class="btn btn-success disabled">Line그래프</a>&nbsp;&nbsp;
...
$(document).ready(function(){
	...
	function createChart() {
		...
		let LineChartDemo = Chart.Line(ctx,{  //chart.js제공 메서드
