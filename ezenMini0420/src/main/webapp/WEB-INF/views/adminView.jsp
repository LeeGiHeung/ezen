...
<body>
<h3 class="text-center multiEffect">관리자 페이지</h3>
<h3 id="authText" class="text-center multiEffect"></h3>
<form action="authAdmin" method="post" id="authForm">
	...
	<div class="form-check-inline">
		<label class="form-check-label" for="radio2">
			<input type="radio" class="form-check-input" id="radio2" name="auth" value="ROLE_MANAGE" />매니저	 
			</label>			
	</div>
	<div class="form-check-inline">
		<label class="form-check-label" for="radio3">
			<input type="radio" class="form-check-input" id="radio3" name="auth" value="ROLE_ADMIN" />총책임자	 
			</label>			
	</div>
