...
<h3 class="text-center wordArtEffect">Abouts</h3>
...
<!-- 연락처 정보 -->
<div class="row">
	<div class="col-md-4 d-flex flex-column"> <!-- d-flex는 flex형식으로 배치 flex-column은 수직배치 -->
		<div class="d-flex flex-row"> <!--flex-row는 수평배치  -->
			<div>
				<i class="fa fa-home" aria-hidden="true"></i> <!-- aria-hidden은 스크린리더 제한 기능 true는 제한 -->
			</div>
			<div>
	...
	<div class="col-md-8">
		<form class="text-right" id="myForm" action="" method="post">
			<div class="row">
				<div class="col-md-6 form-group"> <!-- 그리드 6칸 차지함 -->
					...
					<input name="email" placeholder="Enter email address" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$"
							 ...
							 class="mb-20 form-control" type="email" /> <!-- pattern은 입력형식을 regEx(정규식)으로 지정 -->
					<input name="subject" placeholder="Enter subject" onfocus="this.placeholder = ''" 
						onblur="this.placeholder = 'Enter subject'"	 class="mb-20 form-control" type="text"/>		 		
				</div>
				...
				<div  class="col-md-12"> <!-- 총 그리드 수가 12를 넘었으므로 다음줄에 생킴 -->
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCl3troictldoLX7-RsH7NiFiGVzUWGgv8&callback=initMap1&v=weekly&channel=2">
</script>
