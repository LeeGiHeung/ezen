...
<form action="join" method="post" id="frm1" name="frm1">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="pid" placeholder="E-Mail주소 입력" id="uId" required/>
	</div>
	<div class="form-group">
	...
	<button type="submit" class="btn btn-success" id="join">회원가입</button>&nbsp;&nbsp;
...
$(document).ready(function(){
	...
	$("#join").click(function(){
		var id = $("#uId").val().length;
		var pw = $("#uPw").val().length;
		var address = $("#uAddress").val().length;
		var hobby = $("#uHobby").val().length;
		var profile = $("#uProfile").val().length;
