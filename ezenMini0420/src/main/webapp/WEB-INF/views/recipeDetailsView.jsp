		...
		<form action="recipeorder" method="post" id="rOrder">
			...
			<div class="form-group text-center">
				<h3 class="text-center threeDEffect">
					...
					<input type="number" class="form-control w-50 mx-auto" id="uOrder" size="10"
						name="rOquanty" value="1" required/>
				</h3>
			</div>
			<div class="text-center">
				<button type="button" id="preOrder" class="btn btn-success">주문</button>&nbsp;&nbsp;	
			...
			<div id="orderAdd" class="text-center d-none">
				<div class="form-group text-center">
					...
					<input type="text" name="rOphoneNo" id="phoneNo"  class="form-control w-50 mx-auto" 
						placeholder="전화번호 010-xxxx-yyyy" required/>
				</div>
				<div class="form-group text-center">
					<label for="userAddr">배달처</label>
					<input type="text" name="rOuserAddr" id="userAddr"  class="form-control w-50 mx-auto" 
						placeholder="배달처 주소" required/>
				</div>
...
$("#preOrder").click(function(){
	...
	$("#orderAdd").removeClass("d-none"); //숨겨진 창 보여 주기
});

$("#rOrder").submit(function(event){ //submit이벤트는 form에 소속
