...
<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.4/Chart.min.js"></script>
 <!-- ckeditor -->
<script src="https://cdn.ckeditor.com/ckeditor5/30.0.0/decoupled-document/ckeditor.js"></script><!-- 30.0.0 --> 
<script src="https://ckeditor.com/apps/ckfinder/3.5.0/ckfinder.js"></script><!-- 3.5.0 보다 상위는 에러-->
...
<div id="mainRegion" class="container mt-5 p-0">
	...
	<a id="recipeOLView" class="btn btn-info" href="recipeOLView?rOuser=<c:out value='${user_id}'/>">주문 목록</a>
...
$(document).ready(function(){
	...
	$("#recipeOLView").click(function(event){
		event.preventDefault();		
		$.ajax({
			url : $("#recipeOLView").attr("href"),
			type : "get",
			data : "",
			success : function(data) {
				$("#hjumbo").text("나의 장바구니 페이지 입니다.");
